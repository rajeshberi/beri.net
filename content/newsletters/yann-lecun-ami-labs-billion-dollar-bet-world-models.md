---
title: "Yann LeCun's $1 Billion Bet Against LLMs"
subtitle: "AMI Labs raises $1.03B to build 'world models' — a fundamentally different approach to AI"
date: "2026-03-10"
...
[Advanced Machine Intelligence (AMI Labs)](https://amilabs.xyz/), founded by Turing Prize winner and former Meta chief AI scientist Yann LeCun, [raised $1.03 billion](https://www.reuters.com/business/ex-meta-ai-chief-yann-lecuns-ami-raises-103-billion-alternative-ai-approach-2026-03-10/) today at a $3.5 billion pre-money valuation. The company is building "world models" — AI systems that learn from reality, not just from predicting the next word.

For enterprise AI buyers, this matters. Here's why.

## The Contrarian Bet: World Models vs. LLMs

Every major AI vendor you're evaluating today — OpenAI, Anthropic, Google — builds large language models. They predict text. They're amazing at it. But LeCun's thesis is that [this approach has fundamental limitations](https://techcrunch.com/2026/03/09/yann-lecuns-ami-labs-raises-1-03-billion-to-build-world-models/) for real-world AI systems that need to reason, plan, and operate in complex environments.
...
Instead, AMI Labs is building systems based on [JEPA (Joint Embedding Predictive Architecture)](https://www.turingpost.com/p/lejepa), LeCun's 2022 research framework. The idea: teach AI to understand how the world works — physics, causality, time — not just linguistic patterns.

![Neural network visualization](https://images.unsplash.com/photo-1620712943543-bcc4688e7485?w=1200&auto=format&fit=crop&q=80)
...
1. **The team.** LeCun won the Turing Award (AI's Nobel Prize). LeBrun sold Wit.ai to Facebook. The roster includes Meta's VP for Europe Laurent Solly, high-profile researchers Saining Xie (chief science officer), Pascale Fung, and Michael Rabbat. This is not a speculative bet on a grad student's thesis.

2. **The industrial investors.** Notice who's in the round: Toyota Ventures, Samsung, Temasek, Groupe Industriel Marcel Dassault. These are companies that build physical things — cars, robots, industrial systems. They're not betting on a better chatbot. They're betting on AI that can operate in the real world.

![Research laboratory](https://images.unsplash.com/photo-1582719471137-c3967ffb1c42?w=1200&auto=format&fit=crop&q=80)
...
First disclosed partner: [Nabla](https://techcrunch.com/tag/nabla/), a digital health startup where LeBrun is chairman. In healthcare, LLM hallucinations can be life-threatening. World models that understand causality and physics could be a safer foundation for medical AI.
...
This mirrors Meta's approach with [Llama](/article/ai-operational-infrastructure-funding-shift-2026) — open research accelerates adoption, builds community, and de-risks vendor lock-in for enterprises.

![Data visualization](https://images.unsplash.com/photo-1551288049-bebda4e38f71?w=1200&auto=format&fit=crop&q=80)
...
We've written about [enterprise AI agents](/article/ai-agents-enterprise-adoption-2026) and how companies are moving beyond chatbots to autonomous systems. World models are the next layer: AI that doesn't just predict text, but understands how systems work and can reason about cause and effect.
...
- [AI Operational Infrastructure: The Real $100B Funding Shift](/article/ai-operational-infrastructure-funding-shift-2026) — Broadcom's AI infrastructure bet and what it means for enterprise buyers
- [AI Agents in Enterprise: From Pilot to Production in 2026](/article/ai-agents-enterprise-adoption-2026) — Why autonomous AI agents are replacing chatbots
- [Anthropic vs. The Pentagon: What It Means for Enterprise AI Vendor Risk](/article/anthropic-pentagon-vendor-risk) — AI vendor relationships and supply chain risk management

---

## Know someone who'd find this useful?

Forward this to a colleague navigating the AI landscape. They can subscribe at **beri.net/#newsletter** — it's free, twice a week, and I read every reply.

If you were forwarded this, [subscribe here](https://beri.net/#newsletter).

---

— Rajesh

*I read every response. Share your thoughts on [LinkedIn](https://www.linkedin.com/in/rberi/) or [Twitter/X](https://x.com/rajeshberi).*
