...
On Monday, March 9, 2026, Anthropic [filed a federal lawsuit](https://www.reuters.com/world/anthropic-sues-block-pentagon-blacklisting-over-ai-use-restrictions-2026-03-09/) in California to block the Pentagon from placing it on a national security blacklist. The designation came after Anthropic refused to remove guardrails preventing its AI from being used for autonomous weapons or domestic surveillance.

The Pentagon had been in "[increasingly contentious talks](https://www.reuters.com/business/pentagon-clashes-with-anthropic-over-military-ai-use-2026-01-29/)" with Anthropic for months. Defense Secretary Pete Hegseth officially designated Anthropic as a supply-chain risk on March 5, and Trump ordered the entire federal government to stop using Claude.
...
![AI technology network visualization](https://images.unsplash.com/photo-1639322537228-f710d846310a?w=1200&auto=format&fit=crop&q=80)
...
![Business meeting discussing strategy and risk](https://images.unsplash.com/photo-1557804506-669a67965ba0?w=1200&auto=format&fit=crop&q=80)
...
OpenAI already [announced a deal with the Pentagon](https://www.reuters.com/world/anthropic-sues-block-pentagon-blacklisting-over-ai-use-restrictions-2026-03-09/) shortly after Anthropic's blacklisting. CEO Sam Altman emphasized OpenAI shares the Pentagon's "principles of ensuring human oversight of weapon systems and opposing mass U.S. surveillance."
...
![Security and compliance concept with locks and keys](https://images.unsplash.com/photo-1614064641938-3bbee52942c7?w=1200&auto=format&fit=crop&q=80)
*Photo by [regularguy.eth](https://unsplash.com/@moneyphotos) on Unsplash*
...
3. **Track the lawsuit** — This case will set precedent. Bookmark [Reuters AI coverage](https://www.reuters.com/technology/artificial-intelligence/) and assign someone on your team to watch for updates.
...
- [Oracle-OpenAI Stargate Collapse: What Enterprise Buyers Need to Know](/article/openai-oracle-stargate-collapse-vendor-risk) — When billion-dollar AI partnerships implode, who pays the price?
- [US AI Guidelines vs. Anthropic: The Enterprise Risk Nobody's Talking About](/article/us-ai-guidelines-anthropic-pentagon-clash) — The backstory to this lawsuit: how Anthropic and the Pentagon ended up in court.
- [GPT-5.4 vs. Claude Opus 4.6: The Enterprise AI Buyer's Guide](/article/gpt-5-4-vs-claude-opus-4-6-enterprise-guide) — Comparing the top AI models for enterprise deployment.
